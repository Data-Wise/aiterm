...
| **Phase 0.7** | Quick Wins (flow-cli style) | ⏳ Next |
...
1. **Feature Workflow Implementation** - Start Phase 1b: `ait feature status/start/cleanup` commands
2. **Workflow Templates** - Start Phase 1: `ait recipes list/show/apply`
3. **Verify Releases** - Test `pip install aiterm-dev==0.3.12` and `brew upgrade aiterm` work correctly
4. **Phase 0.7 Quick Wins** - `ait ghost` aliases, terminal-aware switch, help style improvements
