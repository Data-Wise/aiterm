...
- **craft plugin** - Claude Code commands, skills, and orchestration (v1.2.0)
...
### craft v1.2.0
- 46 commands (code, test, arch, plan, docs, site, git)
- 8 skills (design, testing, architecture, planning, orchestration)
- 1 orchestrator agent
- Mode system (default, debug, optimize, release)
- Smart commands (/craft:do, /craft:check, /craft:help)
...
- **craft plugin v1.2.0+** - Required for command integration
