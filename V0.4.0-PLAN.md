...
| **Phase 0.6** | Ghostty Multi-Terminal Support | ✅ COMPLETE |
| **Phase 0.7** | Quick Wins (flow-cli style) | ✅ COMPLETE |
| **Phase 0.8** | Ghostty Enhancements (iTerm2 parity) | ✅ COMPLETE |
| **Phase 1** | Workflow Templates | ⏳ Planned |
| **Phase 1b** | Feature Workflow Commands | ✅ COMPLETE |
...
### aiterm v0.3.12 (Current - Dec 30, 2025)
...
**Deliverables:**
1. ✅ Terminal detection system (6 terminals: iTerm2, Ghostty, Kitty, Alacritty, WezTerm, Apple Terminal)
2. ✅ Ghostty backend (250 lines): config parsing, theme management, fonts
3. ✅ Ghostty CLI (280 lines): status, config, theme, font, set commands
4. ✅ 14 built-in themes with auto-reload
5. ✅ 19 new tests (all passing)
6. ✅ Documentation: `docs/guide/terminals.md`
...
|-------|---------|--------|--------|----------|
| 0.8.1 | Profile management | ~2h | ✅ DONE | `profile list/show/apply/create/delete` |
| 0.8.2 | Config backup | ~1h | ✅ DONE | `backup`, `restore` |
| 0.8.3 | Keybind management | ~2h | ✅ DONE | `keybind list/add/remove/preset` |
| 0.8.4 | Session control | ~3h | ✅ DONE | `session save/restore/list/split` |

**Completed (Dec 30, 2025):**
- ✅ GhosttyProfile dataclass with config serialization
- ✅ Profile storage in `~/.config/ghostty/profiles/*.conf`
- ✅ Profile CRUD operations (list, get, save, delete, create_from_current, apply)
- ✅ Config backup with timestamped files
- ✅ Backup restore with pre-restore safety
- ✅ CLI commands: `ait ghostty profile list/show/create/apply/delete`
- ✅ CLI commands: `ait ghostty backup`, `ait ghostty restore`
- ✅ GhosttyKeybind dataclass with config parsing
- ✅ Keybind presets (vim, emacs, tmux, macos)
- ✅ CLI commands: `ait ghostty keybind list/add/remove/preset`
- ✅ GhosttySession dataclass with JSON storage
- ✅ Session storage in `~/.config/ghostty/sessions/*.json`
- ✅ CLI commands: `ait ghostty session list/show/save/restore/delete/split`
- ✅ 96 Ghostty tests (34 new for Phase 0.8.3-0.8.4)
