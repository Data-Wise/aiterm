...
| **Phase 0.8** | Ghostty Enhancements (iTerm2 parity) | 🔄 In Progress |
...
**Status:** 🔄 In Progress (0.8.1-0.8.2 complete, 0.8.3-0.8.4 remaining)
...
| 0.8.3 | Keybind management | ~2h | ⏳ Planned | `keybind list/add/remove/preset` |
| 0.8.4 | Session control | ~3h | ⏳ Planned | `session save/restore/list/split` |
...
- ✅ 18 new tests (62 total Ghostty tests)
