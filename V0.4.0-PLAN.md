...
| **Phase 0.8** | Ghostty Enhancements (iTerm2 parity) | ⏳ Planned |
...
| Phase | Feature | Effort | Commands |
|-------|---------|--------|----------|
| 0.8.1 | Profile management | ~2h | `profile list/show/apply/create/delete` |
| 0.8.2 | Config backup | ~1h | `backup`, `restore` |
| 0.8.3 | Keybind management | ~2h | `keybind list/add/remove/preset` |
| 0.8.4 | Session control | ~3h | `session save/restore/list/split` |
