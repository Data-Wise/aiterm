...
- [ ] Add tutorial progression flowchart
- [ ] Add context detection diagram
...
**Tasks:**
- [ ] Create `docs/demos/tutorials/` directory
- [ ] Create VHS tape for `ait doctor`
- [ ] Create VHS tape for `ait detect`
- [ ] Create VHS tape for `ait switch`
- [ ] Generate all Getting Started GIFs
- [ ] Generate Intermediate GIFs
- [ ] Generate Advanced GIFs
...
2. [ ] Create `docs/diagrams/` directory
3. [ ] Add tutorial progression Mermaid diagram
4. [ ] Create first VHS tape (`ait doctor`)
